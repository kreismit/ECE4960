...
void loop()
{
  ...
  //{
    ...
    myMotorDriver.setDrive( i, 1, power); //Drive motor i forward at full speed
    myMotorDriver.setDrive( j, 0, power); //Drive motor j forward at full speed
    delay(250);
    //digitalWrite( LEDPIN, 0 );
    myMotorDriver.setDrive( i, 0, power); //Drive motor i backward at full speed
    myMotorDriver.setDrive( j, 1, power); //Drive motor j backward at full speed
    delay(250);
    myMotorDriver.setDrive( i, 1, 0);
    myMotorDriver.setDrive( j, 1, 0);
    delay(500);
  //}
}
